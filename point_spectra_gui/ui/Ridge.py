    ...
    def retranslateUi(self, Form):
        ...
        self.fitInterceptCheckBox_cv.setToolTip(
            _translate("Form", "Whether to calculate the intercept for this model. If set to false,\n"
                               ...
                               "be already centered)."))
        self.fitInterceptCheckBox_cv.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
        self.normalizeLabel_cv.setText(("Normalize "))
        self.normalizeCheckBox_cv.setToolTip(
        ...
        self.normalizeCheckBox_cv.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
        self.scoringLabel_cv.setText(("Scoring"))
        self.scoringComboBox_cv.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
        ...
        self.gCVModeComboBox_cv.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
        ...
        self.storeCVValuesCheckBox_cv.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
        self.Ridge.setTitle(("Ridge"))
        self.alphaLabel.setText(("Alpha"))
        self.alphaDoubleSpinBox.setToolTip(
            _translate("Form", "Regularization strength; must be a positive float. Regularization\n"
                               ...
                               ""))
        self.alphaDoubleSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
        ...
        self.maxNumOfIterationslineEdit.setToolTip(
            _translate("Form", "Maximum number of iterations for conjugate gradient solver. For\n"
        ...
        self.randomStateLineEdit.setToolTip(
            _translate("Form", "The seed of the pseudo random number generator to use when shuffling\n"
                               "the data. If int, random_state is the seed used by the random number\n"
                               "generator; If RandomState instance, random_state is the random number\n"
                               "generator; If None, the random number generator is the RandomState\n"
                               "instance used by np.random. Used when solver == \'sag\'."))
        self.randomStateLineEdit.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
        ...
        self.solverComboBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
        ...
        self.crossValidateCheckBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html"))
