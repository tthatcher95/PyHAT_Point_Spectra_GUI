...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.optimizeWCrossValidaitonLabel)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.optimizeWCrossValidaitonCheckBox)
