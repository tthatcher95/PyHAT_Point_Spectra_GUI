...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.fit_interceptCheckBox.setToolTip(("Whether to calculate the intercept for this model. If set to false, no intercept will be used in calculations (e.g. data is expected to be already centered)."))
        ...
        self.precomputeComboBox.setToolTip(("Whether to use a precomputed Gram matrix to speed up calculations. If set to \'auto\' let us decide. The Gram matrix can also be passed as argument."))
        ...
        self.fit_pathCheckBox.setToolTip(("If True the full path is stored in the coef_path_ attribute. If you compute the solution for a large problem or many targets, setting fit_path to False will lead to a speedup, especially with a small alpha."))
        ...
        self.positiveCheckBox.setToolTip(("Restrict coefficients to be >= 0. Be aware that you might want to remove fit_intercept which is set True by default."))
