...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 504, 350))
        ...
        self.menuFile.addAction(self.actionRestore_Trained_Model)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionSave_Current_Workflow)
        self.menuFile.addAction(self.actionSave_Trained_Model)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.refreshModulePushButton.setToolTip(("<html><head/><body><p>Re-run your last ran module</p></body></html>"))
        self.refreshModulePushButton.setText(("Refresh Modules"))
        ...
        self.deleteModuleComboBox.setItemText(0, ("Delete Module"))
        ...
        self.actionSave_Current_Data.setText(("Save Current Data to CSV"))
