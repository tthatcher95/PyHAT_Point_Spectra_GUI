...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.pls_checkbox)
        self.pls_nc_label = QtWidgets.QLabel(self.formGroupBox)
        self.pls_nc_label.setObjectName("pls_nc_label")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.pls_nc_label)
        self.pls_spin = QtWidgets.QSpinBox(self.formGroupBox)
        self.pls_spin.setProperty("value", 5)
        self.pls_spin.setObjectName("pls_spin")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.pls_spin)
