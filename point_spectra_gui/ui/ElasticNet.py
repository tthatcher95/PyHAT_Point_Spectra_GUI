...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.l1_ratioLabel.setText(_translate("Form", "l1_ratio\n"
                                                      ""))
        self.l1_ratioDoubleSpinBox.setToolTip(
            _translate("Form", "The ElasticNet mixing parameter, with 0 <= l1_ratio <= 1. For l1_ratio\n"
                               "= 0 the penalty is an L2 penalty. For l1_ratio = 1 it is an L1 penalty.\n"
                               "For 0 < l1_ratio < 1, the penalty is a combination of L1 and L2."))
        self.l1_ratioDoubleSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.epsLabel.setText(_translate("Form", "eps\n"
                                                 ""))
        self.epsDoubleSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.n_alphasLabel.setText(_translate("Form", "n_alphas\n"
                                                      ""))
        self.n_alphasSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.alphasLabel.setText(_translate("Form", "alphas\n"
                                                    ""))
        self.alphasLineEdit.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.fit_interceptLabel.setText(_translate("Form", "fit_intercept\n"
                                                           ""))
        self.fit_interceptCheckBox.setToolTip(
            _translate("Form", "Whether the intercept should be estimated or not. If False, the data\n"
        ...
        self.precomputeComboBox.setToolTip(
            _translate("Form", "Whether to use a precomputed Gram matrix to speed up calculations.\n"
        ...
        self.tolDoubleSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        ...
        self.selectionComboBox.setToolTip(
            _translate("Form", "If set to \'random\', a random coefficient is updated every iteration\n"
                               "rather than looping over features sequentially by default. This\n"
                               "(setting to \'random\') often leads to significantly faster convergence\n"
                               "especially when tol is higher than 1e-4."))
        self.selectionComboBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.cVLabel.setText(("cv"))
        self.cVSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        ...
        self.enl1_ratioLabel.setText(_translate("Form", "l1_ratio\n"
                                                        ""))
        self.enl1_ratioDoubleSpinBox.setToolTip(
            _translate("Form", "The ElasticNet mixing parameter, with 0 <= l1_ratio <= 1. For l1_ratio\n"
                               "= 0 the penalty is an L2 penalty. For l1_ratio = 1 it is an L1 penalty.\n"
                               "For 0 < l1_ratio < 1, the penalty is a combination of L1 and L2."))
        self.enl1_ratioDoubleSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.enfit_interceptLabel.setText(_translate("Form", "fit_intercept\n"
                                                             ""))
        self.enfit_interceptCheckBox.setToolTip(
            _translate("Form", "Whether the intercept should be estimated or not. If False, the data\n"
                               "is assumed to be already centered."))
        self.enfit_interceptCheckBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        ...
        self.encopy_XCheckBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.entolLabel.setText(_translate("Form", "tol\n"
                                                   ""))
        self.entolDoubleSpinBox.setToolTip(("The tolerance for the optimization:"))
        self.entolDoubleSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.enwarm_startLabel.setText(_translate("Form", "warm_start\n"
                                                          ""))
        self.enwarm_startCheckBox.setToolTip(
            _translate("Form", "When set to True, reuse the solution of the previous call to fit as\n"
                               "initialization, otherwise, just erase the previous solution."))
        self.enwarm_startCheckBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        ...
        self.enpositiveCheckBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
        self.enselectionLabel.setText(("selection"))
        self.enselectionComboBox.setToolTip(
            _translate("Form", "If set to \'random\', a random coefficient is updated every iteration\n"
                               "rather than looping over features sequentially by default. This\n"
                               "(setting to \'random\') often leads to significantly faster convergence\n"
                               "especially when tol is higher than 1e-4."))
        self.enselectionComboBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html"))
