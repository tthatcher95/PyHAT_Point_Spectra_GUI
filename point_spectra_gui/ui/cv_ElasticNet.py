...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.n_alphasLineEdit = QtWidgets.QLineEdit(self.elasticNetCVGroupBox)
        self.n_alphasLineEdit.setObjectName("n_alphasLineEdit")
        self.ElasticNetCV_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.n_alphasLineEdit)
        ...
        self.max_iterLineEdit = QtWidgets.QLineEdit(self.elasticNetCVGroupBox)
        self.max_iterLineEdit.setObjectName("max_iterLineEdit")
        self.ElasticNetCV_2.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.max_iterLineEdit)
        ...
        self.tolLineEdit = QtWidgets.QLineEdit(self.elasticNetCVGroupBox)
        self.tolLineEdit.setObjectName("tolLineEdit")
        self.ElasticNetCV_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.tolLineEdit)
        ...
        self.n_jobsLineEdit = QtWidgets.QLineEdit(self.elasticNetCVGroupBox)
        self.n_jobsLineEdit.setObjectName("n_jobsLineEdit")
        self.ElasticNetCV_2.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.n_jobsLineEdit)
        ...
        self.cVLineEdit = QtWidgets.QLineEdit(self.elasticNetCVGroupBox)
        self.cVLineEdit.setObjectName("cVLineEdit")
        self.ElasticNetCV_2.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.cVLineEdit)
        self.l1_ratioLineEdit = QtWidgets.QLineEdit(self.elasticNetCVGroupBox)
        self.l1_ratioLineEdit.setObjectName("l1_ratioLineEdit")
        self.ElasticNetCV_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.l1_ratioLineEdit)
        self.epsLineEdit = QtWidgets.QLineEdit(self.elasticNetCVGroupBox)
        self.epsLineEdit.setObjectName("epsLineEdit")
        self.ElasticNetCV_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.epsLineEdit)
