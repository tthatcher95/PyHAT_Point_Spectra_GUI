...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(("Standardize Data"))
        self.chooseDataLabel.setText(("Choose data to scale"))
        self.label.setText(("Choose data to define means and standard deviations"))
