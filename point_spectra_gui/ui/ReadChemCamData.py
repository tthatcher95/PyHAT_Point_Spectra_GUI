...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.outputFileNameLineEdit, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.column_explain, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.averagesradioButton, 3, 1, 1, 1)
        self.averagesLabel = QtWidgets.QLabel(self.groupBox)
        self.averagesLabel.setObjectName("averagesLabel")
        self.gridLayout.addWidget(self.averagesLabel, 3, 0, 1, 1)
