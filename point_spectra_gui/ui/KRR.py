...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.alphaSpinBox.setToolTip(
            _translate("Form", "Small positive values of alpha improve the conditioning of the problem\n"
        ...
        self.alphaSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.kernel_ridge.KernelRidge.html"))
        self.kernelLabel.setText(("Kernel"))
        self.kernelLineEdit.setToolTip(
            _translate("Form", "Kernel mapping used internally. A callable should accept two arguments\n"
                               "and the keyword arguments passed to this object as kernel_params, and\n"
                               "should return a floating point number."))
        self.kernelLineEdit.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.kernel_ridge.KernelRidge.html"))
        self.kernelLineEdit.setText(("linear"))
        self.gammaLabel.setText(("Gamma"))
        self.gammaLineEdit.setToolTip(
            _translate("Form", "Gamma parameter for the RBF, laplacian, polynomial, exponential chi2\n"
                               "and sigmoid kernels. Interpretation of the default value is left to\n"
                               "the kernel; see the documentation for sklearn.metrics.pairwise.\n"
                               "Ignored by other kernels."))
        self.gammaLineEdit.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.kernel_ridge.KernelRidge.html"))
        ...
        self.degreeDoubleSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.kernel_ridge.KernelRidge.html"))
        self.coeff0Label.setText(("Coeff 0"))
        self.coeff0DoubleSpinBox.setToolTip(
            _translate("Form", "Zero coefficient for polynomial and sigmoid kernels. Ignored by other\n"
                               "kernels."))
        self.coeff0DoubleSpinBox.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.kernel_ridge.KernelRidge.html"))
        self.kernelParametersLabel.setText(("Kernel Parameters"))
        self.kernelParametersLineEdit.setToolTip(
            ("Additional parameters (keyword arguments) for kernel function passed\n"
             "as callable object."))
        self.kernelParametersLineEdit.setWhatsThis(
            ("http://scikit-learn.org/stable/modules/generated/sklearn.kernel_ridge.KernelRidge.html"))
